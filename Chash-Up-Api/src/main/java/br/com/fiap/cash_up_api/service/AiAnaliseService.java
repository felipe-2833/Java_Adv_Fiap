...
public class AiAnaliseService {
    ...
    public String getExpenseAnalise(String language){
        ...
        return chatClient
                    .prompt()
                    //.system("você é um comediante, responda apenas com piadas, não mude de assunto.") -> foi retirado pelo defaultSystem
                    .user("faça uma analise das seguintes despesas: " + json)
